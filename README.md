...
<ul>
<li><i>Preferred</i>: download the most recent version of the caastools wheel (currently <a href="https://github.com/JayWaWa/caastools/blob/master/dist/caastools-0.9.0-py3-none-any.whl">v0.9.0</a>)
